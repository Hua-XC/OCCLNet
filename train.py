...
from loss import HXCD_contrastLosscc as  HXCD_contrastLoss
...
parser.add_argument('--dataset', default='regdb',help='dataset name: regdb or sysu or llcm]')
...
parser.add_argument('--model_path', default='resultZGG/HXC'+HXC_TIME+'/save_model/', type=str, help='model save path')
parser.add_argument('--log_path', default='resultZGG/HXC'+HXC_TIME+'/log/', type=str, help='log save path')
parser.add_argument('--vis_log_path', default='resultZGG/HXC'+HXC_TIME+'/log/vis_log/', type=str, help='log save path')
...
if args.loss_tri == 'QCT':
    ...
    criterion_tri = HXCD_contrastLoss(batch_size=loader_batch)
